...
// Adapted from supernova-experience with warmer tuning for amber/teal/coral palette.
...
export const colorGradeFragmentShader = /* glsl */ `
  ...
  void main() {
    ...
    // Warmer grade than supernova — complement amber/teal/coral
    vec3 lift = vec3(0.005, -0.005, 0.015);
    vec3 gamma = vec3(1.01, 1.0, 0.97);
    vec3 gain = vec3(1.02, 0.99, 1.02);
...
export const vignetteFragmentShader = /* glsl */ `
  ...
  void main() {
    ...
    // Slight deep blue tint in dark edges
